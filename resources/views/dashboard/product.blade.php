    ...
    <div class="row">
        <div class="card shadow-lg mt-4">
            <div class="card-body ms-3">
                <h1 class="card-title fs-5">Product</h1>
                    ...
                    <form action="{{route('product.store')}}" method="post">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input class="form-control bg-white bg-white" name="name" type="text">
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                <label for="example-text-input" class="form-control-label">Deskripsi</label>
                                <input class="form-control bg-white" name="description" type="text">
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
